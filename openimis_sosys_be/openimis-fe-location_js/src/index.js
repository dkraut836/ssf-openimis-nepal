...
const DEFAULT_CONFIG = {
  ...
  "refs": [
    ...
    { key: "location.BankNamePicker", ref: BankNamePicker },
    { key: "location.BankNamePicker.projection", ref: ["BankName", "BankNameEng", "ShortCode", "BankId"]},
    { key: "location.BankTypePicker", ref: BankTypePicker },
    { key: "location.BankTypePicker.projection", ref: ["BranchName", "BranchNameEng","BranchId"]
    },
