...
function reducer(
    ...
    switch (action.type) {
        ...
        case 'LOCATION_USER_HEALTH_FACILITY_FULL_PATH_RESP':
            ...
            case 'LOCATION_BANKS_RESP':
                console.log('bank location reducer', action.payload.data.banks)
                return {
                    ...state,
                    fetchingBankName: false,
            ...
            case 'LOCATION_BANKS_ERR':
                return {
                    ...state,
                    fetchingBankName: false,
                    errorBankName: formatServerError(action.payload)
                };
                case 'LOCATION_BANKTYPES_REQ':
                    return {
                        ...state,
