...
from sosys.models import HFBankDetails
...
class HealthFacilityBankDetailGQLType(DjangoObjectType):
    class Meta:
        model = HFBankDetails
...
class HealthFacilityGQLType(DjangoObjectType):
    ...
    def resolve_bank_details(self,info):
        return self.bank_details.filter(validity_to__isnull=True)
