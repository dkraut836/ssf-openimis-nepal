USE [SSF_BLANK]
GO
/****** Object:  StoredProcedure [dbo].[uspUpdateClaimFromPhone]    Script Date: 1/19/2021 2:16:28 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN TRAN CLAIM
			INSERT INTO tblClaim(InsureeID,ClaimCode,DateFrom,DateTo,ICDID,ClaimStatus,Claimed,DateClaimed,Explanation,AuditUserID,HFID,ClaimAdminId,ICDID1,ICDID2,ICDID3,ICDID4,VisitType,GuaranteeId,SchemeType)
						VALUES(@InsureeID,@ClaimCode,@StartDate,@EndDate,@ICDID,2,@Total,@ClaimDate,@Comment,-1,@HFID,@ClaimAdminId,@ICDID1,@ICDID2,@ICDID3,@ICDID4,@VisitType,@GuaranteeId,@SchemeType);
